export default function Experience(){
    return <section section id="education" className="bg-secondary text-white py-10 px-5 md:px-20">
        ...
        Experience
         ...
         <div className="bg-primary p-5 rounded-xl shadow-lg">
          ...
          <p className="text-lg md:text-xl leading-relaxed mt-2">➢ Specialized in equipment, like calipers, gauges to measure and inspect the visual condition to ensure the 
           product  with absolute parameters specification as given in drawings using (GD&T). Performed through 
           inspections of incoming materials with quality standards.</p>
        </div>
        <div className="bg-primary p-5 rounded-xl shadow-lg">
          ...
          <p className="text-lg md:text-xl leading-relaxed mt-2 font-bold">Aug 2023 - Dec 2024</p>
           ...
           <p className="text-lg md:text-xl leading-relaxed mt-2">➢ Verifying all poke yoke system effectively working at welding line and assembly line through 
           poke yoke audit adherence and confirmation through poke yoke check sheet. </p>
        </div>
       </div>
